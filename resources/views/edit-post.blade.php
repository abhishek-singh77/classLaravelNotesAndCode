{{-- We will create a view for editing the posts --}}
...
Post Details
    ...
    {{-- We will create a form with post method for updating the given post  --}}
    <form method="POST" action="{{route('post.edit')}}">
        @csrf
        <input type="hidden" name="id" value="{{$post->id}}"/>
        {{-- why are fetching this id here?
            The reason is that we are using the same view for editing and creating a new post.
            --}}
